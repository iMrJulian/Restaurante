 ...
 * @author Estudiantes
 */
public class JFrameAperitivo extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameAperitivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
