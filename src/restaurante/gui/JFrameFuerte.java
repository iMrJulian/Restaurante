 ...
 * @author Estudiantes
 */
public class JFrameFuerte extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameFuerte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
